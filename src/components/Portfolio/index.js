...
function Portfolio() {
    ...
    const projects = [
        {   
            id: 'otium',
            url: 'https://otiumcapital.herokuapp.com/',
            git: 'https://github.com/hansonjw/otium-capital',
            image: otium,
            title: "Otium Capital",
            description: "A community dedicated to freeing 'mental capital' from stress and worries over moneythrough collecting, generating, and sharing ideas for investing on a social media style platform "
        },
        {   
            id: 'investing',
